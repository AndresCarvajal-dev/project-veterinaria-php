...
<head>
    ...
    <style>
        /* Small, local styles to improve form appearance */
        body { background: linear-gradient(180deg, #f8fafc 0%, #eef2f7 100%); }
        .card-create { max-width: 720px; margin: 48px auto; box-shadow: 0 6px 24px rgba(20,30,60,0.08); }
...
<div class="card card-create">
    <div class="card-body">
        <div class="d-flex align-items-center mb-3">
            <div class="me-3">
                <span class="badge bg-success rounded-circle p-3"><i class="bi bi-box-seam text-white fs-4"></i></span>
            </div>
            <div>
                <h4 class="card-title mb-0">Crear Producto</h4>
                <small class="text-muted">Agrega un nuevo producto a tu inventario</small>
            </div>
        </div>
        ...
        <form action="{{ route('productos.store') }}" method="POST" novalidate>
            ...
            <div class="mb-3">
                ...
                @else
                    <div class="help-block">Productos veterinarios</div>
                @enderror
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="precio" id="precio" class="form-control @error('precio') is-invalid @enderror" step="0.01" value="{{ old('precio') }}" required>
                    </div>
                    @error('precio')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
